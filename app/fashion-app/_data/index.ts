...
export const user: User = {
  id: 1,
  name: "John Doe",
  image: require("../_images/user/avatar.png"),
};
...
export const products: Product[] = [
  {
    ...
    image: require("../_images/products/yellow-ss.jpg"),
    reviews: 80,
    rating: 2.5,
    colors: colors,
    brand: "Zara",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Odio hendrerit vitae nibh elementum egestas. Duis eleifend turpis tempor purus et aliquam dui risus dui.",
    image: require("../_images/products/green-j.jpg"),
    reviews: 28,
    rating: 3.7,
    colors: colors,
    brand: "Zara",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Odio hendrerit vitae nibh elementum egestas. Duis eleifend turpis tempor purus et aliquam dui risus dui.",
    image: require("../_images/products/hdd.jpg"),
    reviews: 70,
    rating: 5,
    colors: colors,
    brand: "Zara",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Odio hendrerit vitae nibh elementum egestas. Duis eleifend turpis tempor purus et aliquam dui risus dui.",
    image: require("../_images/products/blue-ish-w.jpg"),
    reviews: 65,
    rating: 4.2,
    colors: colors,
    brand: "Zara",
