...
export const studios: Studio[] = [
  {
    id: 1,
    image: require("../_images/studios/viewers-disney.png"),
  },
  {
    id: 2,
    image: require("../_images/studios/viewers-marvel.png"),
  },
  {
    id: 3,
    image: require("../_images/studios/viewers-national.png"),
  },
  {
    id: 4,
    image: require("../_images/studios/viewers-pixar.png"),
  },
  {
    id: 5,
    image: require("../_images/studios/viewers-starwars.png"),
  },
];
// list of movies
export const movies: Movie[] = [
  {
    id: 1,
    image: require("../_images/others/HSMTMTS-gstatic-600x900.jpg"),
    cover: require("../_images/others/covers/high-school-musical-season-2-episode-12-6-1627644411.jpeg"),
    logo: require("../_images/others/logo/hight-school-musical.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "1h 48m",
  ...
  {
    id: 2,
    image: require("../_images/others/blackpantherwakandaforever_lob_crd_06.jpg"),
    cover: require("../_images/others/covers/black-panther.jpeg"),
    logo: require("../_images/others/logo/blackpantherwakandaforever.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "2h 48m",
  ...
  {
    id: 3,
    image: require("../_images/others/image_06aa7fbd.jpeg"),
    cover: require("../_images/others/covers/thor-love-thunder.jpg"),
    logo: require("../_images/others/logo/marvel_Thor_Love_and_Thunder.png"),
    studioId: 1,
    trending: true,
    year: 2022,
    length: "2h 48m",
  ...
  {
    id: 4,
    image: require("../_images/others/LightMagic_FB-TW_KeyArt.jpg"),
    cover: require("../_images/others/covers/light-magic.jpeg"),
    logo: require("../_images/others/logo/light_magic_logo_91_87705617.png"),
    studioId: 1,
    trending: true,
    year: 2018,
    length: "4h 48m",
  ...
  {
    id: 5,
    image: require("../_images/others/moonknight_lob_crd_05.jpg"),
    cover: require("../_images/others/covers/moonknight.jpg"),
    logo: require("../_images/others/logo/marvels-Moon-Knight-Logo-2019.png"),
    studioId: 1,
    trending: true,
    year: 2016,
    length: "1h 48m",
  ...
  {
    id: 6,
    image: require("../_images/others/captain-marvel.jpg"),
    cover: require("../_images/others/covers/captain-marvel-1024x576.jpg"),
    logo: require("../_images/others/logo/captain_Marvel_logo.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "4h 19m",
  ...
  {
    id: 7,
    image: require("../_images/others/MV5BNDgxNTIyZTMtMzYxNi00NmRjLWFiMTEtM2U4MTFmODkzNzM1XkEyXkFqcGdeQXVyMTM1MTE1NDMx._V1_FMjpg_UX1000_.jpg"),
    cover: require("../_images/others/covers/Andor.jpg"),
    logo: require("../_images/others/logo/star-wars-andor-logo.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "2h 39m",
  ...
  {
    id: 8,
    image: require("../_images/others/MV5BZDIyYjM3N2EtOTU1MC00YTA4LTgzNjctMTNjODcxZTZhODU2XkEyXkFqcGdeQXVyMTM1MTE1NDMx._V1_.jpg"),
    cover: require("../_images/others/covers/pinocchio-review.jpeg"),
    logo: require("../_images/others/logo/pinocchio.png"),
    studioId: 1,
    trending: true,
    year: 2019,
    length: "1h 48m",
  ...
  {
    id: 9,
    image: require("../_images/others/night-museum.jpeg"),
    cover: require("../_images/others/covers/night-at-the-museum.jpg"),
    logo: require("../_images/others/logo/night-at-the-musium.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "2h 48m",
...
export const trendingMovies: Movie[] = [
  {
    id: 1,
    image: require("../_images/others/original.jpeg"),
    cover: require("../_images/others/covers/thor-love-thunder.jpg"),
    logo: require("../_images/others/logo/marvel_Thor_Love_and_Thunder.png"),
    studioId: 1,
    trending: true,
  ...
  {
    id: 2,
    image: require("../_images/others/original-2.jpeg"),
    cover: require("../_images/others/covers/Andor.jpg"),
    logo: require("../_images/others/logo/star-wars-andor-logo.png"),
    studioId: 1,
    trending: true,
  ...
  {
    id: 3,
    image: require("../_images/others/original-3.jpeg"),
    cover: require("../_images/others/covers/limitlesswithchrishemsworth.jpeg"),
    logo: require("../_images/others/logo/imitlesswithchrishemsworth_logo_845126e4.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "1h 48m",
  ...
  {
    id: 4,
    image: require("../_images/others/original-4.jpeg"),
    cover: require("../_images/others/covers/night-at-the-museum.jpg"),
    logo: require("../_images/others/logo/night-at-the-musium.png"),
    studioId: 1,
    trending: true,
  ...
  {
    id: 5,
    image: require("../_images/others/original-5.jpeg"),
    cover: require("../_images/others/covers/willow-Disney.jpg"),
    logo: require("../_images/others/logo/Willow_2022.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "1h 48m",
  ...
  {
    id: 6,
    image: require("../_images/others/original-6.jpeg"),
    cover: require("../_images/others/covers/Diary-of-a-Wimpy-Kid-Roderick-Rules.jpg"),
    logo: require("../_images/others/logo/rodrickrules_logo_795_aa122734.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "1h 48m",
  ...
  {
    id: 8,
    image: require("../_images/others/original-8.jpeg"),
    cover: require("../_images/others/covers/the-bad.jpeg"),
    logo: require("../_images/others/logo/star_wars_the_bad_batch_logo.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "1h 48m",
  ...
  {
    id: 9,
    image: require("../_images/others/original-10.jpeg"),
    cover: require("../_images/others/covers/22strange-world.jpg"),
    logo: require("../_images/others/logo/strangeworld_logo_243_b70f606d.png"),
    studioId: 1,
    trending: true,
    year: 2020,
    length: "1h 48m",
