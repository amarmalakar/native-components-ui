import { View, Text, ImageBackground, SafeAreaView, ScrollView, Dimensions, TouchableOpacity } from 'react-native'
...
export default function CoffeeDetails() {
  ...
  const coffee = coffees.find(item => item.id === Number(coffeeId));

  if (!coffee) return <Text style={{ padding: 16 }}>PAGE NOT FOUND!</Text>;
