...
export const user: User = {
  name: "Tugane",
  profile: require("../_images/user/avatar.jpeg"),
};
...
export const Channels: Channel[] = [
  {
    id: 1,
    name: "new york times",
    image: require("../_images/channels/newyorktimes.png"),
  },
  {
    id: 2,
    name: "abc",
    image: require("../_images/channels/abc.png"),
  },
  {
    id: 3,
    name: "bbc",
    image: require("../_images/channels/bbc.png"),
  },
  {
    id: 4,
    name: "cnn",
    image: require("../_images/channels/cnn.png"),
  },
  {
    id: 5,
    name: "espn",
    image: require("../_images/channels/espn.png"),
  },
  {
    id: 6,
    name: "nbc",
    image: require("../_images/channels/nbc.png"),
  },
];
...
export const NewsList: News[] = [
  {
    ...
    image: require("../_images/news/Sports/479f40cd5aa6bf68fdbdfd153b2b2591.jpeg"),
    categoryId: 2,
    time: "3h ago",
    body: newsBody,
  },
  {
    ...
    length: "7 min read",
    author: "John Doe",
    image: require("../_images/news/Sports/81a39-16471564923983-1920.jpg"),
    categoryId: 2,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    image: require("../_images/news/Sports/c366d05c-3661-450f-b6c7-03aac9614442.jpeg"),
    categoryId: 2,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "6 min read",
    author: "John Doe",
    image: require("../_images/news/Sports/logan-weaver-lgnwvr-M5YKACTmdpo-unsplash.jpeg"),
    categoryId: 2,
    time: "4h ago",
    body: newsBody,
  },
  {
    ...
    length: "9 min read",
    author: "John Doe",
    image: require("../_images/news/Sports/logan-weaver-lgnwvr-zPHJ_7seOfA-unsplash.jpeg"),
    categoryId: 2,
    time: "1h ago",
    body: newsBody,
  },
  {
    ...
    length: "1 min read",
    author: "John Doe",
    image: require("../_images/news/Sports/Olsen_MXGP_16-Trentino_2020_JPA__P5I1257.jpeg"),
    categoryId: 2,
    time: "5h ago",
    body: newsBody,
  },
  {
    ...
    image: require("../_images/news/Sports/SteelersCamp_2022_KennyPickett8_2.jpeg"),
    categoryId: 2,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "3 min read",
    author: "Proident ullamco",
    image: require("../_images/news/Fashion/ashim-d-silva-ZmgJiztRHXE-unsplash.jpeg"),
    categoryId: 3,
    time: "7h ago",
    body: newsBody,
  },
  {
    ...
    length: "7 min read",
    author: "John Doe",
    image: require("../_images/news/Fashion/freestocks-_3Q3tsJ01nc-unsplash.jpeg"),
    categoryId: 3,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "5 min read",
    author: "Consectetur Lorem",
    image: require("../_images/news/Fashion/priscilla-du-preez-dlxLGIy-2VU-unsplash.jpeg"),
    categoryId: 3,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "6 min read",
    author: "John Doe",
    image: require("../_images/news/Fashion/reza-delkhosh-iRAOJYtPHZE-unsplash.jpeg"),
    categoryId: 3,
    time: "9h ago",
    body: newsBody,
  },
  {
    ...
    length: "9 min read",
    author: "John Doe",
    image: require("../_images/news/Politcs/aditya-joshi-FOhw4A1CR1Q-unsplash.jpeg"),
    categoryId: 4,
    time: "4h ago",
    body: newsBody,
  },
  {
    ...
    length: "1 min read",
    author: "John Doe",
    image: require("../_images/news/Politcs/colin-lloyd-fThPxIQ6by0-unsplash.jpeg"),
    categoryId: 4,
    time: "1h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Politcs/joshua-sukoff-5DDYHjk_KMU-unsplash.jpeg"),
    categoryId: 4,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "1 min read",
    author: "John Doe",
    image: require("../_images/news/Politcs/katie-moum-o0kbc907i20-unsplash.jpeg"),
    categoryId: 4,
    time: "9h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    // image: require("../_images/news/Politcs/ronda-darby-HbMLSB-uhQY-unsplash.jpeg"),
    image: require("../_images/news/Politcs/ronda-darby-HbMLSB-uhQY-unsplash.jpeg"),
    categoryId: 4,
    time: "4h ago",
    body: newsBody,
  },
  {
    ...
    length: "1 min read",
    author: "John Doe",
    image: require("../_images/news/Finance/akson-1K8pIbIrhkQ-unsplash.jpeg"),
    categoryId: 5,
    time: "5h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Finance/alexander-mils-lCPhGxs7pww-unsplash.jpeg"),
    categoryId: 5,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "1 min read",
    author: "John Doe",
    image: require("../_images/news/Finance/didier-weemaels-ZKVBM2_Dp84-unsplash.jpeg"),
    categoryId: 5,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Finance/online-marketing-hIgeoQjS_iE-unsplash.jpeg"),
    categoryId: 5,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Finance/wance-paleri-NnRIrQ1USyw-unsplash.jpeg"),
    categoryId: 5,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Health/dan-gold-4_jhDO54BYg-unsplash.jpeg"),
    categoryId: 6,
    time: "7h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Health/luke-chesser-rCOWMC8qf8A-unsplash.jpeg"),
    categoryId: 6,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Health/tim-foster-3wAPJB57w6s-unsplash.jpeg"),
    categoryId: 6,
    time: "2h ago",
    body: newsBody,
  },
  {
    ...
    length: "2 min read",
    author: "Voluptate elit",
    image: require("../_images/news/Health/vitalii-pavlyshynets-kcRFW-Hje8Y-unsplash.jpeg"),
    categoryId: 6,
    time: "2h ago",
    body: newsBody,
  },
